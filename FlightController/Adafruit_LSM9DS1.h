/***************************************************************************
  ...
  Slightly modified by Alex Foglia for custom projects, Florence (IT) 
 ***************************************************************************/
...
public:
  ...
  Adafruit_LSM9DS1(int8_t gcs, int32_t sensorID = 0);
  Adafruit_LSM9DS1(int8_t clk, int8_t miso, int8_t mosi,
